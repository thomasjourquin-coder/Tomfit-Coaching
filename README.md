...
Upload des fichiers via GitHub Desktop ou interface web

Activer GitHub Pages dans Settings > Pages

Le site sera accessible à username.github.io/repository-name
...
Drag & drop le zip sur Netlify

Site déployé instantanément avec URL temporaire

Connecter un domaine personnalisé si souhaité
...
Compléter mentions légales avec vraies informations légales

Configurer l'envoi de formulaire avec service tiers

Ajouter vraies photos/vidéos dans la galerie

Tester sur mobile et desktop - différents navigateurs

Optimiser images pour vitesse de chargement

Configurer domaine personnalisé (ex: tomfitcoaching.be)

Ajouter Google Analytics pour suivi

Sauvegarder régulièrement le site complet
